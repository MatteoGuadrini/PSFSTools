...
FunctionsToExport = @("New-ProjectFolder", "Remove-OlderThan", "Backup-ArchiveFiles", "New-TemplateFileServer", "Write-FileServerFromTemplate", "Get-DedupFiles",
                        "Show-LatestCreatedFile", "Show-LatestWritedFile"
                    )
...
AliasesToExport = @("mkprj", "rdold", "bckar", "ntemp", "wfs", "gdf", "slcf", "slwf")
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = @("File-Server", "FS", "Data", "Archive", "File", "Server", "Topology", "Deduplication", "Report")
