...
FunctionsToExport = @("New-ProjectFolder", "Remove-OlderThan", "Backup-ArchiveFiles", "New-TemplateFileServer", "Write-FileServerFromTemplate", "Get-DedupFiles",
                        "Show-LatestCreatedFile", "Show-LatestWritedFile", "Show-LatestAccessedFile"
                    )
...
AliasesToExport = @("mkprj", "rdold", "bckar", "ntemp", "wfs", "gdf", "slcf", "slwf", "slaf")
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = @("File-Server", "FS", "Data", "Archive", "File", "Server", "Topology", "Deduplication", "Duplication", "Report")
